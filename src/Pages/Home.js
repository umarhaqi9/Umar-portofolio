          ...
          <Container>
            ...
            <Navbar.Collapse  id="basic-navbar-nav">
              <Nav className="justify-content-end flex-grow-1 pe-3">
                ...
                <NavDropdown.Item>
                  <Link className="text-black text-decoration-none" to="/personal#hobbies">Hobbies</Link>
                </NavDropdown.Item>
                <NavDropdown.Item>
                  <Link className="text-black text-decoration-none" to="/personal#gadgets">Gadgets</Link>
                </NavDropdown.Item>
                <NavDropdown.Item>
                  <Link className="text-black text-decoration-none" to="/personal#music">Music</Link>
                </NavDropdown.Item>
              </NavDropdown>
              </Nav>
            </Navbar.Collapse>
