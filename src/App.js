  ...
  return (
    <div className='App'>
      <Navbar className='fixed-top' bg="black" variant='dark' expand="lg">
        ...
        {/* Projects Section */}
        <div id='projects' className='reveal bg-white text-dark jumbotron jumbotron-fluid text-center p-5'>
        ...
        {/* About Me Section */}
        <div id='moreaboutme' className='reveal bg-black text-white jumbotron jumbotron-fluid p-5'>
        ...
        {/* Contact Section */}
        <div id='contact' className='reveal bg-white text-dark jumbotron jumbotron-fluid p-5'>
